...
*   **Data Analytics:** Insightful charts and graphs built with Recharts to visualize KPIs, sector allocations, and funding distribution.
...
1.  **Clone the repository:**
    ```bash
    git clone git@github.com:billyws/esip-dfat-dashboard.git
    cd esip-dfat-dashboard
    ```
